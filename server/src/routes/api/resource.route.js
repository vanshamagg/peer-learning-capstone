...
import {validateUpload, isRequestValidated} from '../../services/validator'
...
router.get('/:pk', controllers.getSingle)
router.post('/', multer.single('file'),validateUpload, isRequestValidated, controllers.create);
router.post('/:pk/like', controllers.like)
